...
namespace JumpTheQueue.BDD.Test.Features.Epic3
{
    ...
    public partial class StartQueueFeature : object, Xunit.IClassFixture<StartQueueFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Epic3", "StartQueue", "\tAs an owner/employee, I want to start with the first number of the queue \r\n\tSo t" +
                    "hat I can attend the first customer.", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                StartQueueFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                StartQueueFeature.FeatureTearDown();
            }
        }
    }
}
